...
\assignment{
  What is the set of strategies for each player?
}

\assignment{
  Find the combined (optimal) strategy, which minimizes total cost (summed for both users)?
}
...
\assignment{
  Does the optimal strategy coincide with the NE? (hint: Lagrange multipliers)?
}
