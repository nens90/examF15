...
\item \textbf{Formulate in matrix representation:} The matrix representation \\
  \begin{tabular}{ r|c|c| }
    ...
    \cline{2-3}
  \end{tabular}
\item \textbf{Find Nash equilibrium:} The Nash equilibrium is $(5,4)$ where player 1 choose $B-A-D$ and player 2 choose
  $A-D-C$ 
\item \textbf{What would be the rational choice:}
\end{enumerate}
