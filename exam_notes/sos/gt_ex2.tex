...
\begin{tabular}{ r|c|c| }
  \multicolumn{1}{r}{}
  $p1$\textbackslash $p2$ & \multicolumn{1}{c}{$s_1 = A-D-C$} & \multicolumn{1}{c}{$s_2 = A-B-C$} \\ \cline{2-3}
  $s_1 = B-A-D$           & $(1,1)$                           & $(1,2.5)$                         \\ \cline{2-3}
  $s_2 = B-C-D$           & $(2,1)$                           & $(2,2)$                           \\ \cline{2-3}
\end{tabular}

\assignment{2. Find Nash equilibrium:} 
The Nash equilibrium is $(2,2)$ where player 1 choose $B-C-D$ and player 2 choose $A-B-C$

\assignment{3. What would be the rational choice:}
The best for player 1 is $B-C-D$, and the best for player 2 is $A-B-C$
